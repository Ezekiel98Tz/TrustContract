...
export default function Index({ auth, verifications, filters }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-brand-gold">Business Verifications</h2>}
        >
            <Head title="Business Verifications" />
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex space-x-4">
                            <Link
                                href={route('admin.business-verifications.index')}
                            ...
                            <Link
                                href={route('admin.business-verifications.index', { status: 'pending' })}
                            ...
                            <Link
                                href={route('admin.business-verifications.index', { status: 'approved' })}
                            ...
                            <Link
                                href={route('admin.business-verifications.index', { status: 'rejected' })}
                                ...
                                <div className="overflow-x-auto">
                                    <table className="min-w-full divide-y divide-gray-800">
                                        <thead className="bg-gray-900">
                                            <tr>
                                                <th className="px-6 py-3 text-left text-xs font-bold text-brand-gold uppercase tracking-wider">Business</th>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-bold text-brand-gold uppercase tracking-wider">Document Link</th>
